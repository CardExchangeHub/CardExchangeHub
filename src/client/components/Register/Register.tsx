        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-20">
          <div className="login">
            ...
            >
              ...
              <div className="mt-4 bg-sky-500  text-gray-100 hover:text-white shadow font-bold text-sm py-3 px-4 rounded-lg flex justify-start items-center cursor-pointer w-50 bg-blue-500">
                <svg
                  viewBox="0 0 24 24"
